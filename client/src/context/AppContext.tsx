...
import { type FoodEntry, initialState, type ActivityEntry, type User, type Credentials } from "../types";
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
    ...
    const value = {
        ...
        onboardingCompleted, setOnboardingCompleted, allFoodLogs, allActivityLogs, setAllFoodLogs, setAllActivityLogs
    }
    // @ts-ignore
