          ...
          {step === 3 && (
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="space-y-8 max-w-lg">
                <h3 className="text-md font-medium text-shadow-neutral-800 dark:text-white mb-4">
                  Daily Targets</h3>
                ...
                <div className="space-y-6">
                  ...
                  <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} value={formData.dailyCalorieBurn}
                    onChange={(v) => updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories you aim to burn through exercise and activity each day."/>
                </div>
              </div>
