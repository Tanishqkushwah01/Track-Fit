      ...
      <div className="dashboard-grid">
        ...
        <Card className="shadow-lg col-span-2">
          ...
          <div className="mt-4 flex justify-between items-center">
            <div className={`px-3 py-1.5 rounded-lg ${remainingCalories >= 0 ? 'bg-purple-50 dark:bg-purple-900/10 text-purple-700 dark:text-purple-400' : 'bg-red-50 dark:bg-red-900/10 text-red-700 dark:text-red-400'}`}>
        ...
        <div className="dashboard-card-grid">
          ...
          <Card>
            ...
            <p className="text-2xl font-bold text-slate-800 dark:text-white">{todayActivities.length
            }</p>
            <p className="text-sm text-slate-400">acitivities logged</p>
          </Card>
        </div>
